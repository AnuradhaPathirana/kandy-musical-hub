...
class __TwigTemplate_dc78abdfe924db159869bb2615a67113e63c5e8797fe1625c046232749f3534d extends \Twig\Template
{
        private $source;
        private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t<li>
\t\t\t\t\t<a href=\"https://www.daraz.lk/shop/kandy-musical-hub%20Daraz%20store%20link\" target=\"_blank\">
\t\t\t\t\t\t<img class=\"daraz-link-logo\" src=\"../image/catalog/1.kandy-musical-hub/logo/Daraz_Logo.png\" alt=\"daraz-logo\">
\t\t\t\t\t</a>
\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t<li><a href=\"https://www.daraz.lk/shop/kandy-musical-hub%20Daraz%20store%20link\" target=\"_blank\">Visit Our Daraz Store</a></li>
\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t  </ul>
\t\t\t\t\t\t\t\t\t\t\t</div>
