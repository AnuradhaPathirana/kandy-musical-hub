<?php
// HTTP
define('HTTP_SERVER', 'http://musicalhub.lk/admin/');
define('HTTP_CATALOG', 'http://musicalhub.lk/');

// HTTPS
define('HTTPS_SERVER', 'https://musicalhub.lk/admin/');
define('HTTPS_CATALOG', 'https://musicalhub.lk/');

// DIR
define('DIR_APPLICATION', '/var/www/html/musicalhub/admin/');
define('DIR_SYSTEM', '/var/www/html/musicalhub/system/');
define('DIR_IMAGE', '/var/www/html/musicalhub/image/');
define('DIR_STORAGE', DIR_SYSTEM . 'storage/');
define('DIR_CATALOG', '/var/www/html/musicalhub/catalog/');
