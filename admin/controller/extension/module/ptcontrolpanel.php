...
class ControllerExtensionModulePtcontrolpanel extends Controller
{
    ...
    public function index() {
        ...
        $data['database'] = array(
            DIR_APPLICATION . '../plazadata/plaza_db1.sql' => 'Rozer 1',
            DIR_APPLICATION . '../plazadata/plaza_db2.sql' => 'Rozer 2',
            DIR_APPLICATION . '../plazadata/plaza_db3.sql' => 'Rozer 3',
            DIR_APPLICATION . '../plazadata/plaza_db4.sql' => 'Rozer 4'
        );
        ...
        foreach ($data['stores'] as $store) {
            ...
            } elseif (isset($this->config->get('module_ptcontrolpanel_loader_img')[$store['store_id']]) && is_file(DIR_IMAGE . $this->config->get('module_ptcontrolpanel_loader_img')[$store['store_id']])) {
